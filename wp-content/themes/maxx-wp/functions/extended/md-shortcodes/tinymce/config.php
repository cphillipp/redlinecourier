...
$sc_categories = array();  
$sc_categories_obj = get_categories('hide_empty=0');
foreach ($sc_categories_obj as $sc_cat) {
    $sc_categories[$sc_cat->cat_ID] = $sc_cat->cat_name;}
$categories_tmp = array_unshift($sc_categories, "All Categories");  
...
$zilla_shortcodes['cportfolio'] = array(
	...
	'shortcode' => '[carousel_porfolio columns="{{columns}}" count="{{count}}" order="{{order}}" thumbheight="{{thumbheight}}" itemmargin="{{itemmargin}}"]',
