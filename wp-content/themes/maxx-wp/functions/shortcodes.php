...
function md_googlemap($atts, $content = null) {
   ...
   if($marker == 'true'){
	...
	$str .='<script type="text/javascript" src="https://raw.github.com/marioestrada/jQuery-gMap/master/jquery.gmap.min.js"></script>';
	$str .='<script type="text/javascript">';
		$str .='jQuery(document).ready(function(){';
			$str .='jQuery("#md_google_map_'.$id.'").gMap({';
...
function md_slider_slide( $atts, $content = null ) {
	...
	if($text == ''){
		return '<li><img src="'.$content.'" alt="'.$text.'"></li>';
	}
	else{
		return '<li><img src="'.$content.'" alt="'.$text.'"><p class="flex-caption">'.$text.'</p></li>';
	}
}
