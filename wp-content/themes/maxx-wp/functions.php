...
if( !function_exists( 'md_enqueue_scripts' ) ) {
	...
	function md_enqueue_scripts(){
		...
		wp_register_style('md-custom-google-font-css','http://fonts.googleapis.com/css?family='. $md_custom_google_fonts,'','1.0');
		...
		//Register scripts
		wp_register_script('md-cufon-yui-js',				get_template_directory_uri().'/js/cufon-yui.js','jquery','1.09i',true);        
        wp_register_script('md-cufon-titillium-text-js',	get_template_directory_uri().'/js/TitilliumText.font.js','jquery','1.0',true);
		wp_register_script('md-skitter-slider-js',		get_template_directory_uri().'/js/jquery.skitter-min.js','jquery','3.8',false);
		wp_register_script('md-scripts-js',				get_template_directory_uri().'/js/scripts.js','jquery','1.0',false);
		wp_register_script('md-shortcode-js',				get_template_directory_uri().'/js/shortcode.js','jquery','1.0',false);
		wp_register_script('md-isotope-js', 				get_template_directory_uri() . '/js/jquery.isotope.min.js', 'jquery', '1.5.19', false);
		wp_register_script('md-flex-slider-js',		get_template_directory_uri().'/js/jquery.flexslider-min.js','jquery');
		wp_register_script('md-custom-js',				get_template_directory_uri().'/js/custom.js','jquery','1.0',false);
		wp_register_script('md-fitvid-js',				get_template_directory_uri().'/js/jquery.fitvid.js','jquery','1.0',true);
		wp_register_script('md-froogaloop-js','http://a.vimeocdn.com/js/froogaloop2.min.js','jquery','1.0',true);
