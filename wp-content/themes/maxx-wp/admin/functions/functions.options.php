...
$md_google_font = array(
					'none'	 			=> $url . 'f-none.jpg',
					'Amaranth' 			=> $url . 'f-amaranth.jpg',
					'Cabin' 			=> $url . 'f-cabin.jpg',
					'Cabin Condensed' 	=> $url . 'f-cabin-condensed.jpg',
					'Crimson Text' 		=> $url . 'f-crimson-text.jpg',
					'Dancing Script' 	=> $url . 'f-dancing-script.jpg',
					'Droid Serif' 		=> $url . 'f-droid-serif.jpg',
					'Droid Sans' 		=> $url . 'f-droid-sans.jpg',
					'Lato' 				=> $url . 'f-lato.jpg',
					'Lobster Two' 		=> $url . 'f-lobster-two.jpg',
					'Muli' 				=> $url . 'f-muli.jpg',
					'Nunito' 			=> $url . 'f-nunito.jpg',
					'Open Sans' 		=> $url . 'f-open-sans.jpg',
					'Oswald' 			=> $url . 'f-oswald.jpg',
					'Pacifico' 			=> $url . 'f-pacifico.jpg',
					'PT Sans' 			=> $url . 'f-pt-sans.jpg',
					'PT Sans Narrow' 	=> $url . 'f-pt-sans-narrow.jpg',
					'Quicksand' 		=> $url . 'f-quicksand.jpg',
					'Signika' 			=> $url . 'f-signika.jpg',
					'Ubuntu' 			=> $url . 'f-ubuntu.jpg',
					'Volkhov' 			=> $url . 'f-volkhov.jpg'
				); 
...
$of_options[] = array( "name" => __("Enter font name","framework"),
					"desc" => __("Enter a custom font name ( Ex: Open Sans)<br><br> Checkout <a href='http://www.google.com/webfonts/'>Google Web Fonts.</a> for a complete list of available font.","framework"),
...
$of_options[] = array( "name" => __("Enable Transition effect","framework"),
					"desc" => __("Check this if you want to enable CSS3 Transition effect (only affect to modern Browsers) ","framework"),
					"id" => $shortname."_enable_transition_effect",
					"std" => 1,
					"type" => "checkbox");
